...
<div class="register-box">
  ...
  <div class="register-box-body">
    <p class="login-box-msg"> Subscriber Log In</p>
  ...
  <form method="post" action="login.php">
    ...
    <div class="form-group has-feedback">
      <label for="exampleInputEmail1">User Name</label>
        <input type="text" class="form-control" placeholder="Username" name="susername">
    ...
    <div class="row">
        ...
        <div class="col-xs-4">
         ...
         <div>
          ...
          Not a Subscriber yet <a href="register.php">Register</a>
        </div>
        <!-- /.col -->
      </div>
