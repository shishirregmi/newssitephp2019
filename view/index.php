      ...
      <div class="col-lg-12 col-md-12 col-sm-12">
        <div class="header_top">
          ...
          <div class="header_top_right">
            <p><?php error_reporting(0); echo "Hello&nbsp;" .$adsession;?></p>
    ...
    <nav class="navbar navbar-inverse" role="navigation">
      ...
      <div id="navbar" class="navbar-collapse collapse">
        <ul class="nav navbar-nav main_nav">
          ...
          <li><a href="#">Pc</a></li>
          <li><a href="pages/single_page_console.php">Console</a></li>
...
<?php
          ...
          <div class="single_post_content">
            ...
            <div class="single_post_content_left">
              <ul class="business_catgnav  wow fadeInDown">
                <li>
                  <figure class="bsbig_fig"> <a href="pages/single_page.php" class="featured_img"> <img alt="" src="images/download.png"> <span class="overlay"></span> </a>
      ...
      <div class="col-lg-4 col-md-4 col-sm-4">
        <aside class="right_content">
          ...
          <div class="single_sidebar wow fadeInDown">
            <div class="single_post_content">
                <h2><span>Consoles</span></h2>
                
                <ul class="spost_nav">              
                  
                  
                 <?php
              include 'consoleview.php';
            ?>
                </ul>
              </div>
  ...
  <footer id="footer">
    ...
    <div class="footer_bottom">
      <p class="copyright">Copyright &copy; 2019 <a href="index.php">NewsFeed</a></p>
